...
public class PhotoPagerAdapter2 extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        return PictureSlideFragment2.newInstance(list.get(position).getPath(), list.get(position).getBasePath(), list.get(position).getNeedMoney(), id);//返回展示不同网络图片的PictureSlideFragment
    }
