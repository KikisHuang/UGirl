...
public class PullUpToLoadMore extends ViewGroup {
    ...
    BuyGoodsScrollView topScrollView, bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (BuyGoodsScrollView) getChildAt(0);
                bottomScrollView = (BuyGoodsScrollView) getChildAt(1);
                topScrollView.setScrollListener(new BuyGoodsScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new BuyGoodsScrollView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
